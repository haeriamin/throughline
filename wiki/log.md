...
| 2026-06-19T14:00:00Z | human | throughline.constitution | - | - | Amendment 0.3.2 (PATCH): Principle IV now names the split exception registry (`<target>/.throughline/wiki/exception-registry.md` for slice-scoped, framework `wiki/exception-registry.md` for global) per Amendment 0.3.0; workflow diagram fixed to `/throughline.specify`; confidence-gate summaries in `.github/copilot-instructions.md` + `AGENTS.md` realigned to the 3-band verdict table (removed a stray PARTIAL 0.60–0.69 / <0.60 review band that contradicted Principle V); no semantic change. | .throughline/memory/constitution.md, .github/copilot-instructions.md, AGENTS.md |
